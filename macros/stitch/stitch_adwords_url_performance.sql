...
aggregated as (
    ...
    select
        ...
        nullif(({{ get_url_parameter('finalurl', 'utm_campaign') }})::varchar, '') as utm_campaign
        nullif(({{ get_url_parameter('finalurl', 'utm_source') }})::varchar, '') as utm_source,
        nullif(({{ get_url_parameter('finalurl', 'utm_medium') }})::varchar, '') as utm_medium,
        nullif(({{ get_url_parameter('finalurl', 'utm_content') }})::varchar, '') as utm_content,
        nullif(({{ get_url_parameter('finalurl', 'utm_term') }})::varchar, '') as utm_term,
